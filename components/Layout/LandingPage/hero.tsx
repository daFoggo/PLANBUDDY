    ...
    <section className="container mx-auto px-4 py-24 text-center rounded-lg space-y-8 relative overflow-hidden">
      <div className="animate-fade-in-down">
        <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-primary to-primary-foreground bg-clip-text text-transparent pb-2">
          Plan Meetings in Just 1 Minute
        </h1>
      ...
      <p className="text-lg mx-auto text-muted-foreground max-w-2xl animate-fade-in-up">
        Tired of traditional meeting planning? Schedule quickly and efficiently
        with 1MIN2MEET.
      </p>
      ...
      <div className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-10 right-10 w-32 h-32 bg-primary/10 dark:bg-primary/30 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-primary/10 dark:bg-primary/30 rounded-full animate-pulse"style={{ animationDelay: '2s' }}></div>
      </div>
    </section>
  );
};
